...
docker build -t "ghcr.io/lavinir/amd64-hassonedrive:$($version)" --build-arg BUILD_ARCH=linux-x64 --build-arg SDK_IMAGE_ARCH_TAG=10.0-alpine --build-arg RUNTIME_IMAGE_ARCH_TAG=10.0-alpine-amd64 . 
...
docker build -t "ghcr.io/lavinir/armv7-hassonedrive:$($version)" --build-arg SDK_IMAGE_ARCH_TAG=10.0-alpine --build-arg RUNTIME_IMAGE_ARCH_TAG=10.0-alpine-arm32v7 --build-arg BUILD_ARCH=linux-arm  .  
docker build -t "ghcr.io/lavinir/armhf-hassonedrive:$($version)" --build-arg SDK_IMAGE_ARCH_TAG=10.0-alpine --build-arg RUNTIME_IMAGE_ARCH_TAG=10.0-alpine-arm32v7 --build-arg BUILD_ARCH=linux-arm  . 
...
docker build -t "ghcr.io/lavinir/aarch64-hassonedrive:$($version)" --build-arg SDK_IMAGE_ARCH_TAG=10.0-alpine --build-arg RUNTIME_IMAGE_ARCH_TAG=10.0-alpine-arm64v8 --build-arg  BUILD_ARCH=linux-arm64 . 
